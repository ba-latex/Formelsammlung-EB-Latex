...
\begin{document}
    ...
    \begin{table}[H]
        ...
        \end{tabularx}
    \end{table}
    \bild[1.0]{durchlassstrom.png}{Platzh. für gut}{durchlassstrom}


    \section{Einweggleichrichter}
    \label{sec:Einweggleichrichter}

    %\bild[1.0]{einweggleichrichter.png}{Platzh. für gut}{einweggleichrichter}
    ...
    \bild[1.0]{m2u.png}{Platzh. für gut}{m2u}
    ...
    \end{minipage}
    \begin{minipage}{0.5\columnwidth}
        \bild[1.0]{brückengleichrichter.png}{Platzh. für gut}{brückengleichrichter}
    \end{minipage}
...
\section{LC-Sieb}\label{sec:lc-sieb}
    ...
    \begin{minipage}{0.35\columnwidth}
        \bild[0.8]{lc-sieb.png}{Platzh. für gut}{lc-sieb}
    \end{minipage}
    ...
    \end{minipage}
    \begin{minipage}{0.4\columnwidth}
        \bild[1.0]{spannungsgrenze_z.png}{Platzh. für gut}{spannung_z}
    \end{minipage}\\
    ...
    \end{minipage}
    \begin{minipage}{0.4\columnwidth}
        \bild[1.0]{spannungsgrenze_gegenspannung.png}{Platzh. für gut}{spannung_gegen}
    \end{minipage}\\
    ...
    \end{minipage}
    \begin{minipage}{0.4\columnwidth}
        \bild[1.0]{spannungsgrenze_klipper.png}{Platzh. für gut}{spannung_klipper}
    \end{minipage}\\
    ...
    \end{minipage}
    \begin{minipage}{0.5\columnwidth}
        \bild[1.0]{diode_schalter_auf.png}{Platzh. für gut}{diode_schalter_auf}
    \end{minipage}
    ...
    \end{minipage}
    \begin{minipage}{0.5\columnwidth}
        \bild[1.0]{diode_schalter_zu.png}{Platzh. für gut}{diode_schalter_zu}
    \end{minipage}
    \begin{minipage}{0.3\columnwidth}
        $U_{RL}=U_B-U_S$\\
        $U_{Diode}=U_S$\\
    ...
    \begin{minipage}{0.3\columnwidth}
        \bild[0.8]{kapazitaetsdiode.png}{Platzh. für gut}{kapazitaetsdiode}
    \end{minipage}
    ...
    %! Oh mein gott ist dieses bild schrecklich, wer ist bei denen auf die idee gekommen, einfach höherwertigen text drunterzuklatschen und das bild so zu lassen ~c (ja ich weiß, man kanns erkennen, triggert nur)
    % bildquwuelle: https://www.elektronik-kompendium.de/sites/bau/0201291.htm
    \bild[0.9]{bjt-pinout.png}{Platzh. für gut}{bjt-pinout}
    \noindent
    ...
    \end{minipage}
    \begin{minipage}{0.5\columnwidth}
        \bild[0.8]{basisvorspannung_widerstand.png}{Platzh. für gut}{bv-spannung-widerstand}
    \end{minipage}
    ...
    \end{minipage}
    \begin{minipage}{0.5\columnwidth}
        \bild[0.8]{basisvorspannung_spannungsteiler.png}{Platzh. für gut}{bv-spannung-teiler}
    \end{minipage}
    ...
    \begin{minipage}{0.5\columnwidth}
        ...
        \bild[0.8]{emitter-widerstand.png}{Platzh. für gut}{emitter-widerstand}
    \end{minipage}
    \begin{minipage}{0.5\columnwidth}
        ...
        \bild[1.0]{spannungsgegenkopplung.png}{Platzh. für gut}{spannungsgegenkopplung}
    \end{minipage}

    \section{Transistor-Grundschaltungen}
    \subsection{Emitter-Schaltung}
    %! minipages entfernt, da kollektor schaltung sonst eh hässlich dran geklatscht und bild sehr klein war
    ...
    %\end{minipage}
    %\begin{minipage}{0.3\columnwidth}
        \bild[0.4]{emitter-schaltung.png}{Platzh. für gut}{emitterschaltung}
    %\end{minipage}
    ...
    %\end{minipage}
    %\begin{minipage}{0.3\columnwidth}
    \bild[0.5]{kollektor-schaltung-martin.png}{Danke an Martin für das Bild}{kollektorschaltung}
    %\end{minipage}
    ...
    \end{minipage}
    \begin{minipage}{0.5\columnwidth}
        \bild[1.0]{source-schaltung.png}{Platzh. für gut}{sourceschaltung}
    \end{minipage}
    ...
    \bild[0.7]{drain-schaltung.png}{Platzh. für gut}{drainschaltung}
